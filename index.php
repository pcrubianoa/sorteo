         ...
         <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
               ...
               <a class="navbar-brand" href="index.html">
                   <img src="images/logos/logo.png" alt="" width="90%">
               </a>
               ...
               <div class="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul class="navbar-nav ml-auto">
                     <li class="dropdown nav-item active">
                        <a href="#" class="" data-toggle="dropdown">Inicio <i class="fa fa-angle-down"></i></a>
                     </li>
                     <li class="nav-item dropdown">
                        <a href="#" class="" data-toggle="dropdown">Ganadores <i class="fa fa-angle-down"></i></a>
                     </li>
                  </ul>
               </div>
            </nav>
                  ...
                  <div class="col-lg-8 mx-auto">
                     <div class="banner-content-wrap text-center">
                        ...
                        <div class="banner-btn">
                           <a href="#" class="btn">Crear Sorteo</a>
                        </div>
               ...
               <div class="col-lg-4 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="300ms">
                  <div class="intro-left-content">
                     <h2 class="column-title">
                        <span>POR QUÉ UNIRSE</span>
                         Por qué deberías unirte a tu Sorteo
                     </h2>
                     <p>
                         Los sorteos y concursos son excelentes herramientas para generar mayor reconocimiento de marca y, por supuesto, aumentar las ventas.
                     </p>
                  ...
                  <div class="row">
                     <div class="col-lg-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="400ms">
                        <div class="single-intro-text mb-30">
                           ...
                           <h3 class="ts-title">Estadísticas</h3>
                           <p>
                     ...
                     <div class="col-lg-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="500ms">
                        <div class="single-intro-text mb-30">
                           ...
                           <h3 class="ts-title">Seguridad</h3>
                           <p>
                               Genera la confianza de tus clientes.
                           </p>
                     ...
                     <div class="col-lg-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="600ms">
                        <div class="single-intro-text mb-30">
                           ...
                           <h3 class="ts-title">Accesibilidad</h3>
                           <p>
                              Permite que tus usuarios se registren rápidamente.
                           </p>
                     ...
                     <div class="col-lg-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="700ms">
                        <div class="single-intro-text mb-30">
                           ...
                           <h3 class="ts-title">Ganadores</h3>
                           <p>
                               Selecciona automáticamente los ganadores.
                           </p>
