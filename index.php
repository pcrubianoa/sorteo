               ...
               <div class="collapse navbar-collapse" id="navbarNavDropdown">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="dropdown nav-item">
                        <a href="#" class="" data-toggle="dropdown">Terminos y Condiciones <i class="fa fa-angle-down"></i></a>
                     </li>
      ...
      <!-- banner end-->
       ...
       <section class="ts-contact-form">
           <div class="container">
               ...
               <div class="row">
                   <div class="col-lg-8 mx-auto">
                       <form id="contact-form" class="contact-form" action="contact-form.php.html" method="post">
                           <div class="error-container"></div>
                           <div class="row">
                               <div class="col-md-12">
                                   <div class="form-group">
                                       <input class="form-control form-control-name" placeholder="Número de Identificación" name="name" id="f-name"
                                              type="text" required>
                                   </div>
                               </div>
                           </div>
               ...
               <div class="row">
                  <div class="col-lg-8 mx-auto">
                     ...
                     <div class="copyright-text text-center">
                        <p>Copyright © 2020 Logis ERP. Todo los derechos reservados.</p>
                     </div>
                  </div>
               </div>
            </div>
